...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        'root://cmsxrootd.fnal.gov//store/data/Run2017C/SingleMuon/MINIAOD/31Mar2018-v1/30000/A23B4D54-4637-E811-A97C-FA163E5C9AAE.root'
    )
)

process.TFileService = cms.Service("TFileService", 
    fileName = cms.string('Ntuple_data2017_SingleElectron_EraE.root')
    )
